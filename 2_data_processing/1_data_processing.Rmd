...
data_municipalities_enhanced_path= r"(C:\Users\rados\OneDrive - SGH\WarsawEconometricChallenge\WarsawEconometricChallenge\1_raw_data\municipalities_enhanced.csv)"
```
## Libraries
```{r}
library(tidyverse)
